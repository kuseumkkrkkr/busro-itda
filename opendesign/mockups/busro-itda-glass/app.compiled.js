...
function App() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "stage" }, /* @__PURE__ */ React.createElement("main", { className: `app-shell tab-${tab}`, "aria-label": "\uBC84\uC2A4\uB85C \uC787\uB2E4" }, /* @__PURE__ */ React.createElement(AppHeader, { connection, onSettings: adminEnabled ? () => setSettingsOpen(true) : null }), /* @__PURE__ */ React.createElement("div", { className: "screen-scroll" }, tab === "explore" && /* @__PURE__ */ React.createElement(NationwideScreen, { connection, onChooseJourney: openJourney }), tab === "live" && /* @__PURE__ */ React.createElement(LiveScreen, { journey: activeJourney, connection, legs: effectiveLiveLegs, selectedLeg, setSelectedLeg, arrivals, history, passageCoverage: legCoverage, mappingSummary: liveMappingSummary, loading: liveLoading, error: liveError, notice: liveNotice, onRefresh: () => loadLive(leg), onCollect: collectSnapshot, onExplore: () => changeTab("explore") }), tab === "simulation" && /* @__PURE__ */ React.createElement(SimulationScreen, { journey: activeJourney, replayReady, replayApplicability, connection, simulation, days, setDays, passageCoverage, mappingSummary: replayMappingSummary, loading: simLoading, onRun: runSimulation, onExplore: () => changeTab("explore") }), tab === "journey" && /* @__PURE__ */ React.createElement(JourneyScreen, { journey: activeJourney, connection, onExplore: () => changeTab("explore") })), /* @__PURE__ */ React.createElement(BottomDock, { tab, onChange: changeTab }), adminEnabled && /* @__PURE__ */ React.createElement(SettingsSheet, { open: settingsOpen, onClose: () => setSettingsOpen(false), apiBase, setApiBase, connection, journey: activeJourney, mappings, legs: effectiveOperationalLegs, mappingSummary: operationalMappingSummary, settingsError, onMappingChange: updateMapping, onVerifyMapping: verifyMapping, onReconnect: saveConnection })));
}
