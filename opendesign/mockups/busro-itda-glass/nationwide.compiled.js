...
const RESEARCH_VERIFICATION_LABELS = {
  ...
  PLANNED_NEEDS_LIVE_VERIFY: "\uACC4\uD68D\uC548 \xB7 \uC7AC\uAC80\uC99D \uD544\uC694",
  WALK_GAP_OVER_300M: "\uB3C4\uBCF4 \uACF5\uBC31 \xB7 \uBC84\uC2A4 \uC5F0\uACB0 \uC544\uB2D8",
  RESEARCH_ONLY: "\uCC38\uACE0 \uAE30\uB85D"
};
function ResearchJourneyCards() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "research-journeys" }, /* @__PURE__ */ React.createElement("div", { className: "catalog-heading" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "eyebrow" }, "PUBLIC TRIP RESEARCH"), /* @__PURE__ */ React.createElement("h2", null, "\uC2E4\uC81C \uC5EC\uD589 \uAE30\uB85D\uC5D0\uC11C \uCC3E\uAE30")), /* @__PURE__ */ React.createElement("span", null, "300m \uB3C4\uBCF4 \uC5F0\uACB0")), /* @__PURE__ */ React.createElement("p", { className: "research-intro" }, "\uACF5\uAC1C \uC5EC\uD589\uAE30\uC758 \uB178\uC120\uBC88\uD638\uB97C \uD604\uC7AC TAGO \uCE74\uD0C8\uB85C\uADF8\uC640 \uB300\uC870\uD588\uC2B5\uB2C8\uB2E4. \uC815\uB958\uC7A5\xB7\uBC29\uD5A5\xB7\uC2DC\uAC04\uD45C\uAC00 \uBAA8\uB450 \uD655\uC778\uB41C \uACBD\uC6B0\uC5D0\uB9CC \uC2E4\uC81C \uAC80\uC0C9 \uACB0\uACFC\uB85C \uC2B9\uACA9\uD569\uB2C8\uB2E4."), /* @__PURE__ */ React.createElement("div", { className: "research-list" }, cases.map((item) => {
    ...
    return /* @__PURE__ */ React.createElement("article", { key: item.id, className: `research-card ${item.verification === "ROUTE_LABELS_HYDRATED" ? "verified" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "research-card-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", null, item.region), /* @__PURE__ */ React.createElement("h3", null, item.title)), /* @__PURE__ */ React.createElement("span", null, status)), /* @__PURE__ */ React.createElement("div", { className: "research-route-pills" }, labels.length > 0 ? labels.map((label, index) => /* @__PURE__ */ React.createElement("span", { key: `${item.id}-${label}-${index}` }, label)) : /* @__PURE__ */ React.createElement("small", null, "\uC0C1\uC138 \uB178\uC120\uBC88\uD638 \uBBF8\uAE30\uC7AC")), /* @__PURE__ */ React.createElement("p", { className: "research-note" }, item.notes), /* @__PURE__ */ React.createElement("div", { className: "research-card-foot" }, /* @__PURE__ */ React.createElement("span", null, hydrated, "/", labels.length || 0, " \uD604\uC7AC \uADF8\uB798\uD504 \uB178\uC120"), /* @__PURE__ */ React.createElement("a", { href: item.source_url, target: "_blank", rel: "noreferrer" }, "\uC6D0\uBB38 \uBCF4\uAE30 ", /* @__PURE__ */ React.createElement(Icon, { name: "arrow-square-out" }))));
  })));
}
function NationwideScreen({ connection, onChooseJourney }) {
  ...
  return /* @__PURE__ */ React.createElement("main", { className: "screen nationwide-screen" }, /* @__PURE__ */ React.createElement(JourneyGenerator, { seededStop, onChooseJourney, connection }), /* @__PURE__ */ React.createElement(ResearchJourneyCards, null), adminEnabled && /* @__PURE__ */ React.createElement("details", { className: "route-admin-tools", open: toolsOpen, onToggle: (event) => setToolsOpen(event.currentTarget.open) }, /* @__PURE__ */ React.createElement("summary", null, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Icon, { name: "wrench" }), /* @__PURE__ */ React.createElement("strong", null, "\uB178\uC120 \uB370\uC774\uD130 \uB3C4\uAD6C"), /* @__PURE__ */ React.createElement("small", null, "\uC6B4\uC601\xB7\uAC80\uC99D\uC6A9")), /* @__PURE__ */ React.createElement(Icon, { name: "caret-down" })), toolsOpen && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "route-admin-intro" }, /* @__PURE__ */ React.createElement("p", null, "\uAC1C\uBCC4 \uB178\uC120 \uC870\uD68C\uC640 \uACBD\uC720 \uC21C\uC11C \uC810\uAC80\uC6A9 \uD654\uBA74\uC785\uB2C8\uB2E4.")), /* @__PURE__ */ React.createElement(RouteBrowser, { connection, onUseStop: setSeededStop }))));
}
