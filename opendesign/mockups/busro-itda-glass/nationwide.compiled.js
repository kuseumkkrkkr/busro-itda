...
function OSMRouteMap({ geometry, stops, positions, loading }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "osm-map-wrap" }, /* @__PURE__ */ React.createElement("div", { ref: elementRef, className: "osm-map", "aria-label": "OpenStreetMap \uAE30\uBC18 \uC804\uAD6D \uBC84\uC2A4 \uC9C0\uB3C4" }), /* @__PURE__ */ React.createElement("span", { className: "osm-attribution-pill" }, /* @__PURE__ */ React.createElement(Icon, { name: "globe-hemisphere-east" }), " OSM"), loading && /* @__PURE__ */ React.createElement("div", { className: "map-loading" }, /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("p", null, "\uACF5\uC2DD \uC815\uB958\uC7A5\uACFC \uB178\uC120 \uD615\uC0C1 \uBD88\uB7EC\uC624\uB294 \uC911")));
}
...
function StopLookup({ label, value, onChange, selected, onSelect, cityCode }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "stop-lookup" }, /* @__PURE__ */ React.createElement("label", null, /* @__PURE__ */ React.createElement("span", null, label), /* @__PURE__ */ React.createElement("div", { className: "stop-input-shell" }, /* @__PURE__ */ React.createElement(Icon, { name: "map-pin" }), /* @__PURE__ */ React.createElement("input", { value: selected ? selected.node_name : value, onChange: (event) => {
    ...
    setResults([]);
  } }, /* @__PURE__ */ React.createElement("strong", null, stop.node_name), /* @__PURE__ */ React.createElement("small", null, stop.city_name || stop.city_code || "\uC9C0\uC5ED \uBBF8\uC0C1", " \xB7 ", stop.node_id)))));
}
...
function GraphCoverage({ networkStatus, result }) {
  ...
  const topologySummary = topologyTargets ? `\uBC29\uD5A5 \uC21C\uC11C ${formatCount(topologyComplete)}/${formatCount(topologyTargets)}` : "\uBC29\uD5A5 \uC21C\uC11C DATA_GAP";
  return /* @__PURE__ */ React.createElement("div", { className: `graph-coverage ${graphReady ? "catalog-ready" : "catalog-gap"}` }, /* @__PURE__ */ React.createElement("span", { className: "graph-pulse", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, primaryStatus), /* @__PURE__ */ React.createElement("small", null, catalogSummary, " \xB7 ", topologySummary)), /* @__PURE__ */ React.createElement("span", { className: "graph-method" }, "\uB2E8\uBC29\uD5A5 Dijkstra"), !graphReady && /* @__PURE__ */ React.createElement("small", { className: "coverage-gap" }, "TAGO \uB178\uC120\uBCC4 \uACBD\uC720 \uC21C\uC11C\uC758 \uC804\uAD6D \uC801\uC7AC\uAC00 \uB05D\uB098\uC9C0 \uC54A\uC544, \uD655\uC778\uB41C \uAD6C\uAC04\uB9CC \uAC80\uC0C9\uD569\uB2C8\uB2E4."), graph && /* @__PURE__ */ React.createElement("small", { className: topologyReady ? "coverage-query" : "coverage-gap" }, "\uC774\uBC88 \uAC80\uC0C9: ", formatCount(graph.nodes), "\uAC1C \uC0C1\uD0DC \xB7 ", formatCount(graph.edges), "\uAC1C \uC2B9\uCC28 \uAC04\uC120 \xB7 ", graph.algorithm || "directed_dijkstra"), graph && !topologyReady && /* @__PURE__ */ React.createElement("small", { className: "coverage-gap" }, "DATA_GAP \xB7 \uAC80\uC0C9 \uAC00\uB2A5\uD55C \uAC80\uC99D \uB178\uC120 \uC21C\uC11C\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4."));
}
function JourneyGenerator({ seededStop, onChooseJourney, connection }) {
  ...
  async function generate(event) {
    ...
    setResult(null);
    try {
      setResult(await BusroApi.generateJourneys({ from_stop_id: fromStop.node_id, to_stop_id: toStop.node_id, from_city_code: fromStop.city_code || void 0, to_city_code: toStop.city_code || void 0, preference, max_alternatives: 5 }));
    } catch (reason) {
